...
<div align="center">
  <h1>Hi there, I'm Parth Suri! 👋</h1>
  <p><strong>Data Scientist & Software Developer | Quant & AI Enthusiast</strong></p>
  <p><em>Bridging the gap between raw data insights, robust software development, quantitative finance, and generative AI.</em></p>
...
## 📁 Projects by Domain & Tech Segment

Explore my technical ecosystem structured across diverse domains. **Click on any card** below to explore repositories matching that domain segment:
...
<table style="width: 100%; display: table;" width="100%" border="0" cellpadding="8" cellspacing="10">
  ...
  <tr>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=data-science" target="_blank" style="text-decoration: none;">
        <h3>📊 Data Science</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=data-engineering" target="_blank" style="text-decoration: none;">
        <h3>🏗️ Data Engineering</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=gen-ai" target="_blank" style="text-decoration: none;">
        <h3>🤖 Gen AI</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
  ...
  <tr>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=ai-ml" target="_blank" style="text-decoration: none;">
        <h3>🧠 AI-ML</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=mlops" target="_blank" style="text-decoration: none;">
        <h3>🔄 MLOps</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=devops" target="_blank" style="text-decoration: none;">
        <h3>🚀 DevOps</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
  ...
  <!-- ROW 4: Security & Quantitative Finance -->
  <tr>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=cybersecurity" target="_blank" style="text-decoration: none;">
        <h3>🔒 Cybersecurity</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=quant-trader" target="_blank" style="text-decoration: none;">
        <h3>📈 Quant Trader</h3>
        <p style="font-size: 13px; color: #58a6ff; margin: 5px 0 0 0;">Explore Projects ↗</p>
      </a>
    </td>
    <td width="33.3%" align="center" valign="middle" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 8px; padding: 20px;">
      <a href="https://github.com/PSURI1894?tab=repositories&q=quant-researcher" target="_blank" style="text-decoration: none;">
...
I am always excited to discuss new projects, open-source ideas, or professional opportunities in Data Science, Machine Learning, or Software Engineering.
